...
router.post('/saveAvatar',function(req, res) {
console.log('---SAVE AVATAR----');

var sp = JSON.stringify(req.body);
var p = sp.split(",");
var v = p[0].replace(/"/g,"");
var vv = v.replace(/{/g,"");
...
if (req.isAuthenticated()) {
fs.writeFile('src/server/data/' + req.user.id + '/fotos_alumnes/'+vv+'.jpg', c, 'base64', function(err) {
      if (err) {
        throw err;
      }
      console.log('The file has been saved!');
